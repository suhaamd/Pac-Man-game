...
// There are lines for using visuals in the code 
//but they are commented out because 
//I want to show the output on the console
...
{	
	...
	public static void main(String[] args)
	{
		...
		// ==========================================
	    // QUESTION 1 & 2: Value Iteration Agent
	    // ==========================================
	    System.out.println("\n========================================");
	    System.out.println("Testing Value Iteration Agent");
	    System.out.println("========================================");
	    
	    // Visualize agent
	    //exec.runGameTimed(new ValueIterationAgent(), new NullGhosts(), true);
	    
	    // Run 20 games against NullGhosts for evaluation (as per specification)
	    exec.runExperiment(new ValueIterationAgent(), new NullGhosts(), 20);
	    
	    // ==========================================
        // QUESTION 3 & 4: Policy Iteration Agent
        // ==========================================
        System.out.println("\n========================================");
        System.out.println("Testing Policy Iteration Agent");
        System.out.println("========================================");
        
        // Visualize agent
        //exec.runGameTimed(new PolicyIterationAgent(), new NullGhosts(), true);
        
        exec.runExperiment(new PolicyIterationAgent(), new NullGhosts(), 20);
        
        
        // ==========================================
        // QUESTION 5 & 6: Q-Learning Agent
        // ==========================================
        System.out.println("\n========================================");
        System.out.println("Testing Q-Learning Agent");
        System.out.println("========================================");
        
        // Visualize agent
        //exec.runGameTimed(new QLearningAgent(), new StarterGhosts(), true);
        
        exec.runExperiment(new QLearningAgent(), new StarterGhosts(), 50);
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
		//exec.runGameTimed(new QLearningAgent_template(),new StarterGhosts(),visual);
		//*/
